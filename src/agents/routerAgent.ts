...
export const routerAgent = new Agent({
  name: "Domain Router",
  instructions: `You classify a user's natural language question into a domain for the Tig Agent SDK. Choose exactly one domain from the available options.
...
- Choose the most specific domain that matches the query intent
- If a query could fit multiple domains, choose the most relevant one
